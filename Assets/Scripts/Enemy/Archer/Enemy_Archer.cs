...
public class Enemy_Archer : Enemy
{
    ...
    public float safeDistance; // how close player shoulfd be to trigger jump on battle state 
    [HideInInspector] public float lastTimeJumped;

    [Header("Additional collision check")]
    [SerializeField] public Transform groundBehindCheck;
    [SerializeField] public Vector2 groundBehindCheckSize;
